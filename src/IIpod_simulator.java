...
public interface IIpod_simulator {
    ...
    /**
     * Este metodo bloquea / Desblocquea el dispositivo, para que no se ejecute ninguna
     * accion cuando esta bloqueado
     ...
     * @return Un cadena que contiene el estado de la informacion
     */
     ...
     * @param index el indice en el que se encuentra la cancion eliminada
     * @exception Exception Cuando el indice esta fuera de rango
     */
